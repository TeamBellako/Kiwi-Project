...
INSERT INTO conversations (
    id, name, type, sprite, expresion, background, fx, dark, dialog, dialog_m, dialog_w, delay_start_ms, delay_end_ms, next_event, event_id, on_completed_action, on_completed_entity, on_completed_entity_id, conditional_variable_for_next_event, fallback_event_id
) VALUES
