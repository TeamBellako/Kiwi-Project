...
public class NodesControllerTests {
    ...
    public void listNodes_valid_returnsOk() throws Exception {
        ...
        when(nodesService.getNodesForUser(1L))
                .thenReturn(List.of(
                        new NodesDTO(1L, NodeStatus.OPEN.name(), 100, 0.5f, 0.5f, 1L, "node1", "Node 1", List.of(2L)),
                        new NodesDTO(2L, NodeStatus.LOCKED.name(), 120, 0.7f, 0.25f, 4L, "node2", "Node 2", List.of())
                ));
    ...
    public void unlockNode_valid_returnsOk() throws Exception {
        ...
        when(nodesService.unlockNode(1L, 1L))
                .thenReturn(new NodesDTO(1L, NodeStatus.OPEN.name(), 100, 0.5f, 0.5f, 1L, "node1", "Node 1", List.of(2L)));
    ...
    public void completeNode_valid_returnsOk() throws Exception {
        ...
        when(nodesService.completeNode(1L, 2L))
                .thenReturn(List.of(new NodesDTO(3L, NodeStatus.LOCKED.name(), 150, 0.8f, 0.4f, 5L, "node3", "Node 3", List.of())));
