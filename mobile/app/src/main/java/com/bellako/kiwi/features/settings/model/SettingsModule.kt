...
object SettingsModule {
    @Provides
    @Singleton
    fun provideJwtAuthInterceptor(authRepository: AuthRepository): JwtAuthInterceptor = JwtAuthInterceptor(authRepository)

    @Provides
    @Singleton
    fun provideSettingsApi(jwtAuthInterceptor: JwtAuthInterceptor): ISettingsAPI {
        val client =
            OkHttpClient
                .Builder()
