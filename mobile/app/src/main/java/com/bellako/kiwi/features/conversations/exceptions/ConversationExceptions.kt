 ...
 */
class ConversationNotFoundException(message: String = "Conversation not found") : Exception(message)

class ConversationValidationException(message: String = "Invalid conversation data") : Exception(message)
...
class ServerException(message: String = "Server error occurred") : Exception(message)
