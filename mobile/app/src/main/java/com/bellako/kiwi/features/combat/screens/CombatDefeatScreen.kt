...
@Composable
private fun SkillsUsedList(skillsUsed: List<SkillUsedSummary>) {
    LazyColumn(
...
private data class SkillUsedSummary(
    val name: String,
    val count: Int,
    val iconRes: Int?,
...
private fun buildSkillUsedSummary(
    combat: CombatDomain,
